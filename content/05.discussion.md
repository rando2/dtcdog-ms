...
While the authors did not have access to this dog’s four-generation pedigree, it would be surprising that such a high amount of wolf ancestry would be [%246-start] missed [%247-start] by other tests.
...
Therefore, these findings suggest that methodological literacy is important to interpreting the results of DTC tests, but the average [%247-end] consumer is unlikely to have the information or training to critically evaluate these features.
