...
Breed organization registration of each dog was confirmed through viewing the dog's breed organization paperwork or locating the dog in the Ammerican Kennel Club (AKC) database.
...
This design ensured that there could be no cross-contamination from another dog in the study.
...
Dog breed classification is a classic problem in computer vision, and models trained on images from a large compendium (ImageNet) have been evaluated for their performance in classifying photographs of purebred dogs, with the model NASNet showing particularly robust perforamnce [@doi:10.1007/s11633-020-1261-0; @doi:10.1109/SISY.2018.8524715; @doi:10.1109/ICITEED.2019.8929955].
Therefore, NASNet can offer a comparison to the DTC genetic tests by predicting breeds based on the photograph exclusively.
...
Because the classifer provides estimates for a large number of categories with a very long tail, only results with a score greater than 1% were included in the analysis.
