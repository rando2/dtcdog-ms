...
The [%279-start] [%280-start] probability of both the treatment and control results coming from the same distribution[]{.
comment-end id="279"} was evaluated using a one-tailed Fisher's exact test.
