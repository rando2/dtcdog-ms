...
[%289-start] [%290-start] These range-format estimates were converted to approximate numeric estimates for visualization purposes (i.e., Figure [%289-end] ).
...
We used these determinations, rather than the percentages (Figure different companies reported results did not affect our analyses.
...
and the breakdown between the two conditions are reported.
