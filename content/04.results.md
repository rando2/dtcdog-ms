...
In one case, a result returned by NASNet ("Lhasa") is not a known dog breed, and "Lhasa Apso" was assumed to be the intended breed.
...
Most tests returned at least one result that did not match the dog's breed organization registration at 100%.
