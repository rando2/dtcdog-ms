...
[%289-start] [%290-start] These range-format estimates were converted to approximate numeric estimates for visualization purposes (i.e., Figure different companies reported results did not affect our analyses.
